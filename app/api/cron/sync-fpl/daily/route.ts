// app/api/cron/sync-fpl/full/route.ts
...
export async function POST(request: Request) {
    ...
    try {
        console.log('Starting FPL full data refresh');

        // Perform full refresh with database update
        const result = await refreshManager.performFullRefresh();
